...
INPUTBOXIMAGEACTIVE = pyglet.image.load('images/usernameBoxActive.png')
INPUTBOXIMAGENOTACTIVE = pyglet.image.load('images/usernameBoxNotActive.png')
CenterImage(INPUTBOXIMAGEACTIVE)
CenterImage(INPUTBOXIMAGENOTACTIVE)
INPUTBOXIMAGEACTIVESPRITE = pyglet.sprite.Sprite(INPUTBOXIMAGEACTIVE, 750, 290)
INPUTBOXIMAGENOTACTIVESPRITE = pyglet.sprite.Sprite(INPUTBOXIMAGENOTACTIVE, 750, 290)

TOPKILLERIMAGE = pyglet.image.load('images/topkiller.png')
CenterImage(TOPKILLERIMAGE)
TOPKILLERSPRITE = pyglet.sprite.Sprite(TOPKILLERIMAGE, 750, 810)
TOPKILLERSPRITE.opacity = 150